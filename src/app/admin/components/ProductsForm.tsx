                ...
                <FormField
                  ...
                  render={({ field }: { field: any }) => (
                    <FormItem className="items-start flex w-full flex-col justify-start">
                      ...
                      <FormDescription className="text-[12px]">
                        This is the same as colors, upload the types of the
                        products ithe variant is a product ,paste the link here
                      </FormDescription>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>
                              ...
                              store, just paste the link in the input field
                              below
                            </DialogDescription>
                          </DialogHeader>
                  ...
                  render={({ field }) => (
                    <FormItem className="items-start flex w-full flex-col justify-start">
                      ...
                      <FormDescription className={`text-[12px] text-red-400`}>
                        if no slug is set , it will be set automatically. This
                        is the product reference, setting an invalid slug will
                        result in errors laters
                      </FormDescription>
                      <FormControl>
                        <Input
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="items-start flex w-full flex-col justify-start">
                      ...
                      <FormDescription className="text-[12px]">
                        This space is for any Additional information that you
                        want to add
                      </FormDescription>
                      <FormControl>
                        <Textarea
                ...
                <FormField
                  ...
                  render={({ field }: { field: any }) => (
                    <FormItem className="items-start flex w-full flex-col justify-start">
                      ...
                      <FormDescription className="text-[12px]">
                        Select an offer from below, if you dont see the offer
                        you want to add please add it first in the offers page
                      </FormDescription>

                      <FormControl></FormControl>

                      <div className="max-w-full mx-auto  overflow-hidden hover:overflow-x-auto whitespace-nowrap">
                        {isPending ? <ClipLoader /> : offers.data.map((item: any, index:number) => (
                          <div
                            key={index}
                            onClick={() => {
                              const updatedValue = () => {
